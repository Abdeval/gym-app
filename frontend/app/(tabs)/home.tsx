...
export default function HomeScreen() {
  ...
  return (
    <View className="flex-1 bg-background-dark">
      <Header leftIcon="barbell" title="Home" showNotification={showNotification} />
      ...
      <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View className="relative z-50 flex-1 justify-end pb-2 p-4">
            ...
            <Text className="text-gray-200 text-base">Ready to crush today{"'"}s workout?</Text>
          </View>
          ...
          <View className="relative z-50 bg-black/30 rounded-3xl p-4 border border-white/20">
            <View className="flex-row items-center justify-between">
              ...
              <TouchableOpacity onPress={handleStartTimer} className="bg-primary rounded-full p-3 ml-3">
        ...
        {activeProgram && (
          <Card className="mb-6">
            ...
            <View className="flex-row items-center justify-between">
              <View className="flex-1">
                <Text className="text-white text-base mb-1">{activeProgram.title}</Text>
        ...
        <Card className="mb-6">
          <View className="flex-row items-center justify-between mb-4">
            <Text className="text-white font-semibold text-lg">Audio & Podcasts</Text>
          ...
          <View className="gap-3">
            ...
            >
              ...
              <View className="flex-1">
                <Text className="text-white font-medium">Featured Podcasts</Text>
                <Text className="text-gray-400 text-sm">Training tips & motivation</Text>
              </View>
